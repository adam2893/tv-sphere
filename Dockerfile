...
RUN which streamlink && streamlink --version
...
RUN echo '#!/bin/sh' > /start.sh && \
    ...
    echo 'echo "Checking streamlink..."' >> /start.sh && \
    echo 'which streamlink && streamlink --plugins' >> /start.sh && \
